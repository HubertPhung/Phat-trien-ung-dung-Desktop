...
namespace ChuDe4
{
    public partial class AccountRolesForm : Form
    {
        ...
        {
            this.Text = $"Vai trò của tài khoản: {_username}";
            LoadRoles();
        }
        ...
        private void LoadRoles()
        {
            ...
            if (dgvRoles.Columns.Contains("RoleName")) dgvRoles.Columns["RoleName"].HeaderText = "Vai trò";
            if (dgvRoles.Columns.Contains("IsActive")) dgvRoles.Columns["IsActive"].HeaderText = "Đang kích hoạt";
